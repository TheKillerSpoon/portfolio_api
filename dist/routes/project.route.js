...
const schema = z.object({
    ...
    showcase: z.coerce.boolean().prefault(false),
});
...
// create new test
projectRoute.post("/project", auth, upload.single("image"), async (req, res) => {
    await create(req, res);
});
// update test by id
projectRoute.patch("/project/:id", auth, upload.single("image"), async (req, res) => {
